import { SQSClient, ChangeMessageVisibilityCommand, ChangeMessageVisibilityBatchCommand, DeleteMessageCommand, DeleteMessageBatchCommand, ReceiveMessageCommand, } from "@aws-sdk/client-sqs";
import { TypedEventEmitter } from "./emitter.js";
import { SQSError, TimeoutError, toStandardError, toTimeoutError, toSQSError, isConnectionError, } from "./errors.js";
...
export class Consumer extends TypedEventEmitter {
    ...
    async receiveMessage(params) {
        try {
            ...
            const result = await this.sqs.send(new ReceiveMessageCommand(params), this.sqsSendOptions);
